...
var studentNames:string[]=["asif", "adnan", "umer", "kamran", "Zeeshan","Shafie", "Hussain"]
function correctionsInArray(a:number, b:number, c:string)
{    studentNames.splice(a,b,c)
    //console.log(studentNames)
    return studentNames;
}
var nameOfStudents:string[]=correctionsInArray(3,1,"Sarfraz")
